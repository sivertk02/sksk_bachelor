...
_INPUT_TRAIN_JSON = os.path.join(_BASE_DIR, 'train_60_mini.json')
_INPUT_VAL_JSON = os.path.join(_BASE_DIR, 'val_20_mini.json')
_INPUT_TEST_JSON = os.path.join(_BASE_DIR, 'test_20_mini.json')

_INPUT_TRAIN_AUG_1_JSON = os.path.join(_BASE_DIR, 'train_60_aug_seed_1_mini.json')
_INPUT_TRAIN_AUG_2_JSON = os.path.join(_BASE_DIR, 'train_60_aug_seed_2_mini.json')

_INPUT_TRAIN_LIST_JSON = [_INPUT_TRAIN_JSON, 
                     _INPUT_TRAIN_AUG_1_JSON, 
                     _INPUT_TRAIN_AUG_2_JSON]
