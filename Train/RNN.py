...
_INPUT_TRAIN_PS_1_JSON = os.path.join(_BASE_DIR, 'train_60_aug_seed_1_mini.json')
_INPUT_TRAIN_IPS_2_JSON = os.path.join(_BASE_DIR, 'train_60_aug_seed_2_mini.json')

_INPUT_TRAIN_LIST_JSON = [_INPUT_TRAIN_JSON]

_OUTPUT_DIR = os.path.join(_BASE_DIR, 'RNN_output')
